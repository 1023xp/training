...
08048330 <main>:
 ...
 8048347:	74 4a                	je     8048393 <main+0x63>
 8048349:	8b 44 24 18          	mov    0x18(%esp),%eax
 804834d:	83 c0 01             	add    $0x1,%eax
 8048350:	89 44 24 18          	mov    %eax,0x18(%esp)
 8048354:	8b 44 24 18          	mov    0x18(%esp),%eax
 8048358:	83 c0 01             	add    $0x1,%eax
 804835b:	89 44 24 18          	mov    %eax,0x18(%esp)
 804835f:	8b 44 24 18          	mov    0x18(%esp),%eax
 8048363:	83 c0 01             	add    $0x1,%eax
 8048366:	89 44 24 18          	mov    %eax,0x18(%esp)
 804836a:	8b 44 24 18          	mov    0x18(%esp),%eax
 804836e:	83 c0 01             	add    $0x1,%eax
 8048371:	89 44 24 18          	mov    %eax,0x18(%esp)
 ...
 8048391:	c9                   	leave  
 8048392:	c3                   	ret    
 8048393:	8b 44 24 1c          	mov    0x1c(%esp),%eax
 8048397:	83 e8 01             	sub    $0x1,%eax
 804839a:	89 44 24 1c          	mov    %eax,0x1c(%esp)
 804839e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
 80483a2:	83 e8 01             	sub    $0x1,%eax
 80483a5:	89 44 24 1c          	mov    %eax,0x1c(%esp)
 80483a9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
 80483ad:	83 e8 01             	sub    $0x1,%eax
 80483b0:	89 44 24 1c          	mov    %eax,0x1c(%esp)
 80483b4:	8b 44 24 1c          	mov    0x1c(%esp),%eax
 80483b8:	83 e8 01             	sub    $0x1,%eax
 80483bb:	89 44 24 1c          	mov    %eax,0x1c(%esp)
